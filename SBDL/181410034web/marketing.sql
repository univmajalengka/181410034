...
--
-- Host: 127.0.0.1
-- Generation Time: 06 Apr 2020 pada 20.19
...
(1, 'admin', '$2y$10$fXzrSH3bZJKflr6FsriSUO5Bn6P5KML093BGZQwxjSgIZIqwL6ug.');
...
INSERT INTO `user_login` (`id`, `nama`, `alamat`, `pekerjaan`) VALUES
(0, 'Fauzan Faturahman Azkia', 'Banjaran', 'Designer Grafis'),
(2, 'Mila Adiawati', 'Majalengka', 'Mahasiswa');
...
--
ALTER TABLE `pesan`
  ADD CONSTRAINT `pesan_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user_login` (`id`),
